...
async function testUploadImage(page) {
  ...
  await page.waitForSelector('body > div.lt-f-col.main-app-wrapper.au-target > div > ct-form > form > div > compose:nth-child(4) > ct-form-group:nth-child(2) > fieldset > div > div.lt-f-3.lt-f-col.form-group-error > dsp-add-new > div > a');
